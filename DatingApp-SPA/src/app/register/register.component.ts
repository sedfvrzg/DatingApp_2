...
export class RegisterComponent implements OnInit {
  ...
  checkPasswordError(passwordType: string, errorType: string) {
    
    return this.registerForm.get(passwordType).touched && this.registerForm.get(passwordType).hasError(errorType);
  }
