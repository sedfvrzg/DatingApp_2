...
namespace DatingApp.API.Data
{
    public class DatingRepository : IDatingRepository
    {
        ...
        {
            return await _context.Photos.Where(usr => usr.UserId == userId).FirstOrDefaultAsync(p => p.IsMain);
        }

        public async Task<Photo> GetPhoto(int id)
        {
            var photo = await _context.Photos.FirstOrDefaultAsync(phto => phto.Id == id);
        ...
        {
            var user = await _context.Users.Include(p => p.Photos).FirstOrDefaultAsync(usr => usr.Id == id);
            return user;
        }
